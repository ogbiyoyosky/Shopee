        ...
        try {
            ...
            if (role_label === "Shop Admin") {
                if (is_accepted) {
                    ...
                    orderDetail.seller_declined_at = moment().format('YYYY-MM-DD HH:mm:ss')
                }
                ...
                if (is_accepted) {
                    orderDetail.buyer_accepted_at = moment().format('YYYY-MM-DD HH:mm:ss')
                } else {
                    orderDetail.buyer_declined_at = moment().format('YYYY-MM-DD HH:mm:ss')
                }
